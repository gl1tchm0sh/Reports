...
def main_process():
    ...
    """
    vdrs = list_vdrs()
    query_1 = "SELECT SUM(ALIAS_0.SUBTOTALIMPORTE) FROM V_TRFACTURAVENTA ALIAS_0 LEFT OUTER JOIN V_TREXTENSION ALIAS_2 ON ALIAS_0.TREXTENSION_ID = ALIAS_2.ID LEFT OUTER JOIN V_ESQUEMAOPERATIVO ALIAS_8 ON ALIAS_2.ESQUEMAOPERATIVO_ID = ALIAS_8.ID LEFT OUTER JOIN V_FLAG ALIAS_4 ON ALIAS_0.FLAG_ID = ALIAS_4.ID WHERE ALIAS_0.BO_PLACE_ID = '{89C23511-3F01-11D5-86AD-0080AD403F5F}' AND   0=0 AND  ALIAS_0.TIPOTRANSACCION_ID = '{89C235A5-3F01-11D5-86AD-0080AD403F5F}' AND ALIAS_4.DESCRIPCION = 'Cerrada' AND ALIAS_8.CODIGO LIKE '01'"
